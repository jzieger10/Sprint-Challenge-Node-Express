...
- [ ] Describe Middleware?
        ...
        Middleware is code that runs in the middle of an operation.

- [ ] Describe a Resource?

        A resource is anything you are routing to, such as a product page, an order summary, a list of names, etc. Whatever the URL points to.
